...
extension SpriteID {
    ...
    static let enemyBossBogmother: SpriteID = "enemy.bossBogmother"
    static let enemyBossThornmaw: SpriteID = "enemy.bossThornmaw"
    static let enemyBossFrostfang: SpriteID = "enemy.bossFrostfang"
    static let enemyBossRimewitch: SpriteID = "enemy.bossRimewitch"
    static let enemyBossPlagueKnight: SpriteID = "enemy.bossPlagueKnight"
    static let enemyBossBloated: SpriteID = "enemy.bossBloated"
    static let enemyBossCinderjaw: SpriteID = "enemy.bossCinderjaw"
    static let enemyBossMagma: SpriteID = "enemy.bossMagma"
    static let enemyBossPitDuke: SpriteID = "enemy.bossPitDuke"
    static let enemyBossFracturedEye: SpriteID = "enemy.bossFracturedEye"
    static let enemyBossRiftweaver: SpriteID = "enemy.bossRiftweaver"
    static let enemyBossWarpedKnight: SpriteID = "enemy.bossWarpedKnight"
    static let enemyBossOathbreaker: SpriteID = "enemy.bossOathbreaker"
