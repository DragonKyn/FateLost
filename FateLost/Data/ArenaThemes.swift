...
enum ArenaThemes {
    ...
    private static let kingdomDecorations: [DecorationRule] = [
        ...
        .cluster(ClusterRule(name: "Silent Village", instances: 5, radius: 4, members: [
            ClusterMember(kind: .plagueBell, count: 1, arrangement: .center),
            ClusterMember(kind: .gravestone, count: 5, arrangement: .ring),
            ClusterMember(kind: .bones, count: 3, arrangement: .scattered),
        ])),
        .scatter(kind: .plagueBell, count: 26, avoidRoads: true),
    ...
    private static let depthsDecorations: [DecorationRule] = [
        ...
        .scatter(kind: .moltenChain, count: 110, avoidRoads: true),
    ...
    private static let shatteredDecorations: [DecorationRule] = [
        ...
        .scatter(kind: .brokenStair, count: 90, avoidRoads: true),
    ...
    private static let citadelDecorations: [DecorationRule] = [
        ...
        .scatter(kind: .siegeRam, count: 40, avoidRoads: false),
    ...
    private static let gateDecorations: [DecorationRule] = [
        ...
        .cluster(ClusterRule(name: "The Gate", instances: 4, radius: 5, members: [
            ClusterMember(kind: .ruinedArch, count: 1, arrangement: .center),
            ClusterMember(kind: .skullPile, count: 4, arrangement: .ring),
        ])),
        .scatter(kind: .ruinedArch, count: 28, avoidRoads: false),
    ...
    private static let abyssDecorations: [DecorationRule] = [
        ...
        .scatter(kind: .hollowThrone, count: 34, avoidRoads: false),
