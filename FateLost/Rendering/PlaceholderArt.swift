...
enum PlaceholderArt {
    ...
    static func sprite(for id: SpriteID) -> Sprite? {
        ...
        case .enemyVampireBat: return vampireBat()
        case .enemyDuskStalker: return duskStalker()
        case .enemyBossPitBrute: return bossPitBrute()
        case .enemyBossBogmother: return bossBogmother()
        case .enemyBossThornmaw: return bossThornmaw()
        case .enemyBossFrostfang: return bossFrostfang()
        case .enemyBossRimewitch: return bossRimewitch()
        case .enemyBossPlagueKnight: return bossPlagueKnight()
        case .enemyBossBloated: return bossBloated()
        case .enemyBossCinderjaw: return bossCinderjaw()
        case .enemyBossMagma: return bossMagma()
        case .enemyBossPitDuke: return bossPitDuke()
        case .enemyBossFracturedEye: return bossFracturedEye()
        case .enemyBossRiftweaver: return bossRiftweaver()
        case .enemyBossWarpedKnight: return bossWarpedKnight()
        case .enemyBossOathbreaker: return bossOathbreaker()
        case .enemyBossSiegeTitan: return bossSiegeTitan()
        case .enemyBossBellkeeper: return bossBellkeeper()
        case .enemyBossGildedRegent: return bossGildedRegent()
        case .enemyRiftForge: return riftForge()
        case .enemyRiftMatriarch: return riftMatriarch()
        case .enemyRiftSovereign: return riftSovereign()
        case .enemyRiftUnblinking: return riftUnblinking()
