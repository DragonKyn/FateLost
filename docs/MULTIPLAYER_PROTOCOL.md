...
u16 projectiles[u32 id,x,y,i8 vx,i8 vy,u16 spriteHash,u8 visual,u8 radius×64,bool hostile] · u8 zones[…] · u8 allies[…] · u16 orbs[…] · u8 drops[…] · u8 shrines[…] · u8 hazards[u32 id,u8 shape,x,y,angle,u8 size×8,u8 width×64,u8 warning×20,u8 age×50,u8 visual,u8 linger×10,u8 flags] · u8 portals[u32 id,u8 kind,bool isReturn,x,y] · u8 rift (0xFF none)`

Caps per snapshot: 450 enemies, 200 projectiles, 40 zones, 100 summons, 150 orbs, 40 drops, 6 shrines, 24 hazards (marked ground from a champion; see [BOSSES.md](BOSSES.md)), 4 portals. `contentVersion` is 5. Hashes are
